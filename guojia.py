...
<link type="text/css" href="http://www.chacuo.net/css/main.css?v=917" rel="stylesheet"/>
<link type="text/css" href="http://www.chacuo.net/css/ui-lightness/jquery-ui-1.8.18.custom.css" rel="stylesheet"/>
<link type="text/css" href="http://www.chacuo.net/css/doc.css?v=917" rel="stylesheet"/>
<script type="text/javascript" src="http://www.chacuo.net/js/public/jquery.min.js"></script>
<script type="text/javascript" src="http://www.chacuo.net/js/public/jquery-ui-1.8.18.custom.min.js"></script>
<script type="text/javascript" src="http://www.chacuo.net/js/public/main.js?v=917"></script>
<script>
...
<meta name="Keywords" content="全球国家列表，全球国家代号">
<meta name="Description" content="全球国家列表，全球国家代号，二字代码，三字代码，iso-3166-1">
<title>全球国家列表，全球国家代号，二字代号，三字代号,iso-3166-1</title>
</head>
<body id="main">
...
<li class="menu"><a class="menu" href='http://web.chacuo.net' title="web开发人员工具、网站开发工具">web开发工具</a>
</li>
...
<li class="menu"><a class="menu" href='http://tool.chacuo.net/mailsend' title="提供邮箱测试及管理基本工具！">邮箱工具</a>
</li>
...
<li class="menu"><a class="menu" href="http://doc.chacuo.net/dashang" target="_blank" style="color:yellow;margin-left:20px; font-weight:normal;font-size:14px; ">赞助</a>
</li>
</ul>
<div class="top_slide">
...
<div class="table f16p tc">
<h1>iso-3166-1全球国家名称代码</h1>
<p>
请按“ Ctrl+F ”，查找(注意选择:“向上/向下”) 所需要的汉字或字符的区位码.
</p>
<h1>&nbsp;</h1>
<table class="f14">
<thead>
...
<div class="foot_copy">
&copy; 2017查错IT网.&nbsp;&nbsp;Update:2017-07-20&nbsp;&nbsp;
<a href="http://doc.chacuo.net/dashang" target="_blank"><strong>赞助</strong></a>&nbsp;&nbsp;
...
<li><a href="http://www.miibeian.gov.cn/" target="_blank" rel="nofollow">粤ICP备13083991号</a></li>
</ul>
</div>
</div>
<script type="text/javascript" src="http://www.chacuo.net/??/js/public/jquery-ui-1.8.18.custom.min.js,/js/public/json2.js,/js/public/jquery.store.js,/js/public/main.js?v=917"></script>
...
t ='''
            <a data-bn-ipg="pages-5" data-ra_arg="ra_null|2" data-page="2" href="http://plan.qyer.com/search_0_0_236_0_0_0_2/?cityid=7919" class="ui_page_item ui_page_next" title="下一页">下一页</a>
            '''
urlp = re.compile("href=\"(http:.*\d)\" class=\"ui_page_item ui_page_next\"")
resu = urlp.findall(t)
print(resu[0])

'''
    
city_pattern = re.compile(u'(?<=<tr>)\n(?:<td>.*</td>\n){2}<td>(\d*)</td>\n(?:<td>.*</td>\n){2}<td>(.*)</td>\n(?:<td>.*</td>\n){3}(?=</tr>)')



cityresult = city_pattern.findall(s)
for i,item in enumerate(cityresult):
    print(item)'''